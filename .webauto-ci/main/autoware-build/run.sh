...
mkdir -p src
vcs import src --recursive < $WEBAUTO_CI_SOURCE_PATH/repositories/autoware.repos
vcs import src --recursive < $WEBAUTO_CI_SOURCE_PATH/repositories/simulator.repos
